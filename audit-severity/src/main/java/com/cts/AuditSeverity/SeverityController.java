...
public class SeverityController {
	...
	public SeverityController(AuditRequestResponse service, AuthClient authClient, AuditCheckListProxy checklistProxy,
			TokenService tokenService, Environment env, AuditBenchmarkFeignclient auditBenchmarkFeignclient) {
		super();
		this.service = service;
		this.authClient = authClient;
		this.checklistProxy = checklistProxy;
		this.tokenService = tokenService;
		this.env = env;
		this.auditBenchmarkFeignclient = auditBenchmarkFeignclient;
	}
